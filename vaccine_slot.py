...
generateOTP = input("Enter your Mobile Number (without any code) -> ")
auth_link = f"https://cdn-api.co-vin.in/api/v2/auth/public/{generateOTP}"
confirmOTP = input("OTP -> ")
conf_link = f"https://cdn-api.co-vin.in/api/v2/auth/public/{confirmOTP}"
